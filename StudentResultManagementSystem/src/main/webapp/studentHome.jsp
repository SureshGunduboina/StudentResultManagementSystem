...
try{
	...
	ResultSet rs=st.executeQuery("select * from students inner join result on students.rollNo=result.rollNo where students.rollNo='"+rollNo+"'");
    if(rs.next()){
%>
<img src="logo.png"  align="left"width="150" height="150">
<center><img src="abc.png" width="150" height="150">
<img src="logo.png" align="right"  width="150" height="150"></center>
...
Designed & Developed </h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ ABC@gmail.com </h6></center> 
  <hr class="new1">
</body>
<%
    }else{
